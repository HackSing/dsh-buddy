// Add multimodal (image input) configuration fields to the bundled dsh Models
// settings UI for the llm-pi-ai provider.
//
...
// edit YAML by hand.
//
// This module owns the transform only.  Target resolution and the CLI live in
// scripts/patch-multimodal-ui.js, which patches the host dependency tree at
// postinstall — see that file for why the profile tree is the wrong target.
...
module.exports = { patchClient, patchFile };
