...
//
// 用途是降级——内嵌 dsh 的原生 Win32 目录选择器曾用 koffi.view()(external
// ArrayBuffer)读对话框返回的路径,而 Electron 禁用该能力,调用即崩。上游在
// 0.1.5-rc.1 已改为非 external 读法,原生对话框在 Electron 下恢复可用;本模块
// 保留为原生对话框在某台机器上仍不可用时的退路:browse 在网页内选目录,完全不碰
// 原生对话框与 koffi。
//
