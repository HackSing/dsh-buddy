# c1 合同层证据:钉版与预装清单形状(2026-09-10)

## package.json 的 @deepseek-ai 钉版
```
条目数: 33
非 0.1.5-rc.1 的条目: [["@deepseek-ai/cordis-plugin-group","1.0.1"]]
...
```
47:const DSH_VERSION = '0.1.5-rc.1'; // 与 package.json dependencies 保持一致(dsh 仍是 developer preview)
```

## 全仓代码面 0.1.1-rc.2 残留(docs/plans、docs/INDEX.md、CHANGELOG.md 为历史条目,按规则保留)
```
CHANGELOG.md
docs/INDEX.md
docs/plans/dsh-upgrade-0.1.1-rc.2.json
docs/plans/dsh-upgrade-0.1.1-rc.2.md
```
